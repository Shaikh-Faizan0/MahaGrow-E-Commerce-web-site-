    ...
    <div >
      {cart.length > 0 ? (
        <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row justify-center ">
          ...
          <div className="w-[100%] md:w-[40%] mt-5  flex flex-col">
            ...
            <div className="font-semibold text-xl text-green-800 ">Your Cart</div>
              ...
              <p className="text-xl">
                <span className="text-white font-semibold text-xl">Total Items: {cart.length}</span>
              </p>
              <p className="text-xl text-white font-bold"><span className="text-white font-semibold">Total Amount:</span> ${totalAmount}</p>
        ...
        <div className="min-h-[80vh] flex flex-col items-center justify-center">
          <h1 className="text-white font-bold italic text-xl mb-2">
            Your cart is empty!
          </h1>
          <Link to={"/"}>
